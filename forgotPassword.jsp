    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <body>
            <div class="forgot-container">
                ...
                <form action="${pageContext.request.contextPath}/controller/forgotPassword" method="post">
                ...
                <div class="form-footer text-center mt-3">
                    Remembered your password? <a href="${pageContext.request.contextPath}/controller/login"
